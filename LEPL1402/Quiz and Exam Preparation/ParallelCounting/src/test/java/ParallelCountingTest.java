...
public class ParallelCountingTest {
    @Test
    public void test1() {
        float[] values = new float[] {4.5f,3.2f,5.0f,6.6f,7.2f,1.5f,3.7f,5.8f,6.0f,9.0f,1.3f,2.3f,4.5f,1.5f,1.1f};
        Assert.assertEquals(2,ParallelCounting.parallelCount(Optional.of(values),4.5f,11));
    }
